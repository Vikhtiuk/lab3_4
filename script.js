...
let todos = [{ id: 991, text: 'Learn Python', check: true }, { id: 992, text: 'Help our country to win the war', check: true }, { id: 993, text:'Read a book' , check: false },{ id: 994, text:'Studying' , check: true }];
let id = 0;
if (todos.length != 0) {
    render();
}
